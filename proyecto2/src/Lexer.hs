...
alex_table = listArray (0 :: Int, 2054)
  [ 0
  , 23
  , 23
  , 23
...
alex_check = listArray (0 :: Int, 2054)
  [ -1
  , 0
  , 1
  , 2
...
alex_action_7 = \_ -> TokenEq
alex_action_8 = \_ -> TokenLt
alex_action_9 = \_ -> TokenGt
alex_action_10 = \_ -> TokenNeq
alex_action_11 = \_ -> TokenLeq
alex_action_12 = \_ -> TokenGeq
alex_action_13 = \_ -> TokenNot
alex_action_14 = \_ -> TokenIf
alex_action_15 = \_ -> TokenLet
alex_action_16 = \_ -> TokenLambda
alex_action_17 = \_ -> TokenBool True
alex_action_18 = \_ -> TokenBool False
alex_action_19 = \s -> TokenNum (read s)
alex_action_20 = \s -> TokenVar s
alex_action_21 = \s -> error ("Lexical error: caracter no reconocido = "
                                    ++ show s
                                    ++ " | codepoints = "
                                    ++ show (map fromEnum s))
