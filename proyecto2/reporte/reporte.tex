...
\section{Ventajas y desventajas de los modelos mixtos}
...
\bibitem{JS-Closures}
  Mozilla Developer Network, “Clausuras (Closures),” [En línea]. Disponible en: https://developer.mozilla.org/es/docs/Web/JavaScript/Guide/Closures.

\bibitem{Lisp-DScope}
  M. Sperber y P. Thiemann, “Dynamic Scope Analysis,” [En línea]. Disponible en:
...
\bibitem{GNU-Bash} 
  GNU Project, “Bash Reference Manual,” [En línea]. Disponible en: https://www.gnu.org/software/bash/manual/bash.html.
