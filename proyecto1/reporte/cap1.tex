...
\begin{enumerate}
    ...
    \begin{tcolorbox}[title=Corrección 1: (Objetivos) (Módulo que corresponde), colframe=red!75!black, colback=red!5!white ]
    \begin{enumerate}[start=3]
    \item Diseñar la sintaxis abstracta del lenguaje utilizando dos representaciones: Un ASA con azúcar sintáctica y un AST que repesenta el núcleo sin azúcar en nuestra implementación.
    \end{enumerate}
    \end{tcolorbox}
...
\begin{tcolorbox}[title=Corrección 2: Objetivos (Módulo ), colframe=red!75!black, colback=red!5!white]
\begin{itemize}
    \item La semántica implementada se restringe al nivel estructural (small-step),
describiendo únicamente reglas de transición paso a paso, sin incluir análisis
estático y optimizaciones.
    \item El alcance del proyecto se restringe a la construcción del intérprete. Aunque los compiladores y los intérpretes comparten fases como el análisis léxico y sintáctico, este proyecto no aborda generación de código, optimización ni traducción a lenguaje maquina.  
\end{itemize}
\end{tcolorbox}
