...
\bibitem{Dybving}
Dybvig, R. K. (2009). The Scheme Programming Language (4th ed., pp. 45-47). MIT Press.

\bibitem{M06} Disponible en:
Soto Romero, M. (2025). Semántica Dinámica [Nota de clase de la Unidad 2: Especificación Formal de los Lenguajes de Programación]. Curso de Lenguajes del Programación, Facultad de Ciencias, Universidad Nacional Autónoma de México.
\textcolor{links}{\uline{\url{https://lambdasspace.github.io/LDP/notas/ldp_n06.pdf}}}

\bibitem{kahn1987N}
Kahn, G. (1987). Natural Semantics. In \textit{Proceedings of STACS} (Vol. 247, pp. 22--39). Springer.

\bibitem{abelson1996}
Abelson, H., Sussman, G. J. (1996). \textit{Structure and Interpretation of Computer Programs} (2nd ed.). MIT Press.

\bibitem{landsman}
Landsmann, M. and others. (2019).A compositional natural semantics for letrec.(Vol. 3, pp. 1--29)
