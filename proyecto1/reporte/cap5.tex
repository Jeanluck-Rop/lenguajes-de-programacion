...
Con este componente, obtenemos un sistema completo: comenzamos con la especificación formal, definimos su semántica, y finalmente construimos un ejecutor funcional que sigue rigurosamente dichas reglas. Esto garantiza que el lenguaje \texttt{MINILISP} no solo está formalmente fundamentado, sino que también es operacionalmente realizable.
