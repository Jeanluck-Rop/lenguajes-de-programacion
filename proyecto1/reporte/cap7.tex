...
\begin{minted}[fontsize=\small, bgcolor=black!5, frame=single]{text}
  ...
  ghci> asa = parse tokens 
  ghci> desugar asa
  IfC (EqualC (NumC 4) (NumC 0)) (EqualC (NumC 0) (AddC (NumC 9) (NumC 3))) (BoolC False)
\end{minted}
...
\begin{minted}[fontsize=\small, bgcolor=black!5, frame=single]{text}
  ...
  ghci> asa = parse tokens 
  ghci> desugar asa
  IfC (DiffC (NumC 1) (NumC 1)) (DiffC (NumC 1) (SubC (NumC 7) (NumC 7))) (BoolC False)
\end{minted}
...
\begin{minted}[fontsize=\small, bgcolor=black!5, frame=single]{text}
[MiniLisp]> (let ((y 31) (x -22)) (cond [(< x 0 y) (- 0 x y)] [(= x 0) 0] [else (+ x 1)]))
53
\end{minted}
...
\begin{minted}[fontsize=\small, bgcolor=black!5, frame=single]{text}
[MiniLisp]> [[1, 2], (3, 4), (not #t), (+ 1 2 3 4 5 6), (!= 9 7 3 5), [], (/ 2 4), (not (not (= 9 9))), (tail [1, 2, 3]), ((lambda (f x) (f x)) (lambda (y) (* y y)) 4)]
...
Para implementar las funciones de prueba, necesitamos modificar nuestro menú interactivo, pues necesitamos detecar estas funciones de prueba
