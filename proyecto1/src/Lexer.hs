...
alex_table = listArray (0 :: Int, 5811)
  [ 0
  , 44
  , 44
  , 44
...
alex_check = listArray (0 :: Int, 5811)
  [ -1
  , 0
  , 1
  , 2
...
alex_action_14 = \_ -> TokenEq
alex_action_15 = \_ -> TokenNeq
alex_action_16 = \_ -> TokenLeq
alex_action_17 = \_ -> TokenGeq
...
alex_action_24 = \_ -> TokenLetRec
alex_action_25 = \_ -> TokenLetStar
alex_action_26 = \_ -> TokenIf0
alex_action_27 = \_ -> TokenIf
alex_action_28 = \_ -> TokenCond
alex_action_29 = \_ -> TokenElse
alex_action_30 = \_ -> TokenLambda
...
alex_action_38 = \s -> error ("Lexical error: caracter no reconocido = "
                                      ++ show s
                                      ++ " | codepoints = "
                                      ++ show (map fromEnum s))
